...
export function FAQs(): JSX.Element {
  ...
  return (
    <main className="faqs-page-bg info-page-bg min-h-screen p-10 bg-[linear-gradient(rgba(245,248,251,0.65),rgba(245,248,251,0.65)),url('https://images.unsplash.com/photo-1581056771107-24ca5f033842?auto=format&fit=crop&w=1600&q=80')] bg-cover bg-center">
      ...
      <section className="mt-8 bg-white/95 rounded-3xl shadow-xl p-10 max-w-5xl mx-auto">
        ...
        <p className="text-lg text-gray-600 leading-relaxed mb-8">
          Find answers to common questions about using the MyChart patient
          portal.
        </p>
