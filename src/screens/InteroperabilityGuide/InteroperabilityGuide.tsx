...
export function InteroperabilityGuide(): JSX.Element {
  return (
    <main className="min-h-screen p-10 bg-[linear-gradient(rgba(245,248,251,0.65),rgba(245,248,251,0.65)),url('https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1600&q=80')] bg-cover bg-center">
