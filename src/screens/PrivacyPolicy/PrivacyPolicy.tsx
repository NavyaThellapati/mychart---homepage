...
export function PrivacyPolicy(): JSX.Element {
  return (
<main className="min-h-screen p-10 bg-[linear-gradient(rgba(245,248,251,0.65),rgba(245,248,251,0.65)),url('https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?auto=format&fit=crop&w=1600&q=80')] bg-cover bg-center">
